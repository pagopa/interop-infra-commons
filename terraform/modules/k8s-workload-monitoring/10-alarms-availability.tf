...
locals {
  ...
  total_status_replicas_metric_name     = var.kind == "StatefulSet" ? "kube_statefulset_status_replicas" : var.kind == "Deployment" ? "kube_deployment_status_replicas" : ""
  available_status_replicas_metric_name = var.kind == "StatefulSet" ? "kube_statefulset_status_replicas_available" : var.kind == "Deployment" ? "kube_deployment_status_replicas_available" : ""
...
resource "aws_cloudwatch_metric_alarm" "unavailable_pods" {
  ...
  metric_query {
    ...
    metric {
      ...
      metric_name = local.total_status_replicas_metric_name
  ...
  metric_query {
    ...
    metric {
      ...
      metric_name = local.available_status_replicas_metric_name
      namespace   = "ContainerInsights"
