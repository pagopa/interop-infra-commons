...
| <a name="input_file_url"></a> [file\_url](#input\_file\_url) | The url to be downloaded. Everithing supported by curl. | `string` | n/a | yes |
...
| <a name="output_file_sha256_base64"></a> [file\_sha256\_base64](#output\_file\_sha256\_base64) | The sha256 of the downloaded file formatted as base64 string |
<!-- END_TF_DOCS -->