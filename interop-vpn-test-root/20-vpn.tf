module "vpn" {
  ...
  env           = var.env
  use_saml_auth = var.use_saml_auth
  use_mutual_auth = var.use_mutual_auth
  tags          = var.tags
  ...
  vpn_endpoint_tag_name             = var.vpn_endpoint_tag_name
  authorization_target_network_cidr = var.authorization_target_network_cidr
  authorization_rule_description    = var.authorization_rule_description
